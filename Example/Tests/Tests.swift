...
class Tests: XCTestCase {
    ...
    func testJHValue() {
        ...
        XCTAssertEqual(Kit.jh512(from: data), hash)
    }
    ...
    func testBmw512Value() {
        ...
        XCTAssertEqual(Kit.bmw512(from: data), hash)
    }
    ...
    func testEcho512Value() {
        ...
        XCTAssertEqual(Kit.echo512(from: data), hash)
    }
    ...
    func testSimdEmpty() {
        ...
        XCTAssertEqual(Kit.simd512(from: data), hash)
    }
    ...
    func testBlakeEmpty() {
        ...
        XCTAssertEqual(Kit.blake512(from: data), hash)
    }
    ...
    func testLuffaValue() {
        ...
        XCTAssertEqual(Kit.luffa512(from: data), hash)
    }
    ...
    func testSkein512Value() {
        ...
        XCTAssertEqual(Kit.skein512(from: data), hash)
    }
    ...
    func testKessak512Empty() {
        ...
        XCTAssertEqual(Kit.keccak512(from: data), hash)
    }
    ...
    func testGroestl512Empty() {
        ...
        XCTAssertEqual(Kit.groestl512(from: data), hash)
    }
    ...
    func testShavite512Value() {
        ...
        XCTAssertEqual(Kit.shavite512(from: data), hash)
    }
    ...
    func testCubeHash512Value() {
        ...
        XCTAssertEqual(Kit.cubehash512(from: data), hash)
    }
    ...
    func testX11() {
        ...
        XCTAssertEqual(Kit.x11(from: data), hash)
    }
